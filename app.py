...
with open(r"C:\Users\rragh\OneDrive\سطح المكتب\Project1\Project1\model.pkl", 'rb') as f:
    model = pickle.load(f)

with open(r"C:\Users\rragh\OneDrive\سطح المكتب\Project1\Project1\vectorizer.pkl", 'rb') as g:
